...
class UserSteps extends ScenarioSteps {
    ...
    @Step
    def set_and_store_multiple_product_configurations(def productNumber, def colorNumber, def sizeNumber) {
        pDPage.set__and_store_multiple_product_configurations(productNumber, colorNumber, sizeNumber)
    }
    ...
    @Step
    def set_and_store_multiple_product_configurations_QV(def productNumber, def colorNumber, def sizeNumber) {
        cLPage.set__and_store_multiple_product_configurations_QV(productNumber, colorNumber, sizeNumber)
    }
