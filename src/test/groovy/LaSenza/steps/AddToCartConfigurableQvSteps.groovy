...
class AddToCartConfigurableQvSteps {
    ...
    public void set_multiple_product_configurations_QV() {
        user.set_and_store_multiple_product_configurations_QV(2, 2, 1)
        user.set_and_store_multiple_product_configurations_QV(3, 3, 1)
    }
